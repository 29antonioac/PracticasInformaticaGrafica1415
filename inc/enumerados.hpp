...
enum tipo_malla {PERFIL,MALLA,REVOLUCION_TAPADO, REVOLUCION_NO_TAPADO,BARRIDO_ROTACION,BARRIDO_TRASLACION};
enum tipo_camara {PERSPECTIVA,ORTOGONAL};
enum modo_camara {PRIMERA_PERSONA,TERCERA_PERSONA,EXAMINAR};
